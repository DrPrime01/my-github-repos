...
function Navbar() {
  ...
  return (
    <nav className="bg-[#060A13] xs:bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        ...
        <div className={navBarStyle} id="navbar-default">
          <ul className="flex flex-col items-end p-4 mt-4 bg-[#060A13] rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-[#060A13] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <NavLink
                to="/"
                className="block py-2 pr-4 pl-3 text-gray-200 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                aria-current="page"
              >
                Home
              </NavLink>
