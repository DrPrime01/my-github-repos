...
function Profile() {
    const githubProfileURL = "https://api.github.com/users/drprime01";
  ...
  return (
    <div id='profile' className='w-96 xs:w-auto xs:text-center'>
      <div className="rounded-full w-64 xs:h-80 xs:w-80 h-64 border-gray-400 border-2 bg-cover bg-center flex justify-center items-center mb-3" style={{backgroundImage: `url(${avatar})`}}>
        
      </div>
      <h3 className='text-2xl font-bold mb-2 text-gray-800'>{profileList.name}</h3>
