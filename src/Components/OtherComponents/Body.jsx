...
function Body() {
  return (
    <div className="w-full bg-center bg-cover min-h-screen bg-landingPageBg flex items-center justify-center">
        <div className="container flex items-center justify-center w-full h-full mx-auto px-40">
            <div className="text-center">
                <h1 className="text-[3.5rem] leading-none font-extrabold text-white font-sans mb-6">The place for Dr Prime to build anything from anywhere</h1>
                <p className='text-2xl font-normal text-slate-500 mb-6'>Whether you’re scaling your startup or just learning how to code, GitHub is your home. Join the world’s largest developer platform to build the innovations that empower humanity. Let’s build from here.</p>
